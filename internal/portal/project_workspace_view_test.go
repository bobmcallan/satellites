...
func TestProjectWorkspace_EmptyQueryReturnsRecentRows(t *testing.T) {
	...
	got := buildProjectWorkspaceComposite(context.Background(), stories, docs, nil, nil, "proj_a", projectWorkspaceFilters{Limit: 25}, nil, false)
...
func TestProjectWorkspace_DenyAllMembershipsReturnsEmpty(t *testing.T) {
	...
	got := buildProjectWorkspaceComposite(context.Background(), stories, docs, nil, nil, "proj_a", projectWorkspaceFilters{Limit: 25}, []string{}, false)
...
func TestProjectWorkspace_LimitCapsEachSection(t *testing.T) {
	...
	got := buildProjectWorkspaceComposite(context.Background(), stories, docs, nil, nil, "proj_a", projectWorkspaceFilters{Limit: 5}, nil, false)
...
func TestProjectWorkspace_NoStoreDegrades(t *testing.T) {
	t.Parallel()
	got := buildProjectWorkspaceComposite(context.Background(), nil, nil, nil, nil, "proj_a", projectWorkspaceFilters{Limit: 25}, nil, false)
