...
func TestProjectWorkspace_EmptyQueryReturnsRecentRows(t *testing.T) {
	...
	got := buildProjectWorkspaceComposite(context.Background(), stories, docs, "proj_a", projectWorkspaceFilters{Limit: 25}, nil)
...
func TestProjectWorkspace_DenyAllMembershipsReturnsEmpty(t *testing.T) {
	...
	got := buildProjectWorkspaceComposite(context.Background(), stories, docs, "proj_a", projectWorkspaceFilters{Limit: 25}, []string{})
...
func TestProjectWorkspace_LimitCapsEachSection(t *testing.T) {
	...
	got := buildProjectWorkspaceComposite(context.Background(), stories, docs, "proj_a", projectWorkspaceFilters{Limit: 5}, nil)
...
func TestProjectWorkspace_NoStoreDegrades(t *testing.T) {
	t.Parallel()
	got := buildProjectWorkspaceComposite(context.Background(), nil, nil, "proj_a", projectWorkspaceFilters{Limit: 25}, nil)
...
func TestProjectWorkspaceRender_RowsRenderForSeededRows(t *testing.T) {
	...
	for _, want := range []string{
		"rendered story",
		"rendered doc",
		`data-testid="workspace-stories-list"`,
		`data-testid="workspace-documents-list"`,
		`href="/projects/`,
		`/stories/sty_`,
		`href="/documents/`,
	} {
