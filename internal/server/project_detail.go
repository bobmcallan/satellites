...
func projectDetailHandler(cfg Config) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		stories, err := dispatchStoryList(ctx, projectID)
		if err != nil {
		...
		// description section. Acceptable round-trip count for the
		// small story counts a single project carries today; swap to
		// lazy expand-on-click if a project ever grows past a few
		// hundred rows.
		for i := range stories {
